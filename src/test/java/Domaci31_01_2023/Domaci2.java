...
public class Domaci2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement mis1 = driver.findElement(By.id("menu-item-6408"));
        new Actions(driver)
                .moveToElement(mis1)
                .perform();
        ...
        WebElement mis2 = driver.findElement(By.id("menu-item-5362"));
        new Actions(driver)
                .moveToElement(mis2)
                .perform();
        ...
        WebElement mis3 = driver.findElement(By.id("menu-item-5453"));
        new Actions(driver)
                .moveToElement(mis3)
                .perform();
